        ...
        <div>
            ...
            <div class="max-w-7xl mx-auto">
                ...
                <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                    ...
                    <p class="text-1xl tracking-tight font-extrabold text-gray-900 sm:text-2xl md:text-3xl pt-6">There are <span class="text-turquoise">10</span> days left until your surf adventure!</p>
                    ...
                    <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">See you soon and pura vida!</p>
                    <p class="text-1xl tracking-tight font-extrabold text-gray-900 sm:text-2xl md:text-3xl py-6">Pre-Trip Checklist</p>
                    <div>
                        <label class="flex justify-start items-start">
                            ...
                            <div class="select-none">Send us your flight info</div>
                        </label>
                        <label class="flex justify-start items-start">
                            <div class="bg-white border-2 rounded border-gray w-6 h-6 flex flex-shrink-0 justify-center items-center mr-2 focus-within:border-gray">
                                <input type="checkbox" class="text-turquoise"></input>
                            ...
                            <div class="select-none">Sign our release forms</div>
                        </label>
                        <label class="flex justify-start items-start">
                            <div class="bg-white border-2 rounded border-gray w-6 h-6 flex flex-shrink-0 justify-center items-center mr-2 focus-within:border-gray">
                                <input type="checkbox" class="text-turquoise"></input>
                            ...
                            <div class="select-none">Get packing with our Getting Ready for Your Trip blog post</div>
                        </label>
                        <label class="flex justify-start items-start">
                            <div class="bg-white border-2 rounded border-gray w-6 h-6 flex flex-shrink-0 justify-center items-center mr-2 focus-within:border-gray">
                                <input type="checkbox" class="text-turquoise"></input>
                            ...
                            <div class="select-none">Save our WhatsApp number to your phone</div>
                        </label>
                    </div>
                    </div>
                </main>
